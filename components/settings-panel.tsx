...
const ACCENT_PRESETS = [
  { name: 'Purple', l: 0.75, c: 0.18, h: 290 },
...
const STORAGE_KEY = 'quence-git-theme'

function clampColor(c: OklchColor) { return { ...c, l: Math.min(0.90, Math.max(0.35, c.l)) } }
